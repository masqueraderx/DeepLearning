...
if __name__ == '__main__':
    ...
    data_dir = '/Users/gexueren/Desktop/DeepLearning/torch_learn/Data/hymenoptera_data'
    image_dataset = {x: datasets.ImageFolder(os.path.join(data_dir, x), data_transforms[x]) for x in ['train', 'val']}
    data_loaders = {x: Data.DataLoader(image_dataset[x], batch_size=4, shuffle=True, num_workers=0)
                   for x in ['train', 'val']}
