...
if __name__ == '__main__':
    ...
    # define loss and optimizer for nets
    ...
    for epoch in range(EPOCH):
        ...
        for net, l in zip(nets, losses):
            ...
            l.append(loss_func(pred, test_y).data.numpy())
            layer_inputs.append(layer_input)
            pre_acts.append(pre_act)
            net.train()
        print('EPOCH: ', epoch, '|Origin Loss: %.4f' % losses[0][-1], '|BN Loss: %.4f' % losses[1][-1])
